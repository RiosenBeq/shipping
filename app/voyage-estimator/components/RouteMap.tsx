      ...
      <div className="panel map-panel">
        ...
        <div className="map-svg-wrap">
          ...
          >
            ...
            {/* continents */}
            <path
              d="M 690 260 Q 720 240 760 250 L 800 280 L 820 340 L 830 420 L 800 480 L 770 520 L 740 540 L 720 510 L 700 460 L 680 400 L 670 340 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 600 100 L 700 120 L 760 140 L 800 170 L 780 220 L 720 240 L 680 230 L 640 210 L 610 180 L 590 140 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 800 220 L 870 230 L 900 280 L 880 340 L 840 360 L 810 330 L 790 280 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 950 230 L 1010 240 L 1060 260 L 1080 310 L 1050 360 L 1020 380 L 990 360 L 960 320 L 945 270 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 1140 360 L 1200 380 L 1240 400 L 1220 430 L 1180 440 L 1150 425 Z M 1260 410 L 1320 420 L 1300 445 L 1270 440 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 1180 200 L 1280 220 L 1340 250 L 1380 290 L 1370 340 L 1320 360 L 1270 350 L 1220 320 L 1180 280 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 1410 240 L 1440 260 L 1450 290 L 1430 310 L 1410 290 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 1240 540 L 1340 540 L 1400 560 L 1410 600 L 1380 640 L 1300 645 L 1240 620 L 1220 580 Z"
              fill="#0A1F33"
              opacity="0.92"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 0 100 L 80 110 L 140 140 L 160 200 L 140 280 L 110 360 L 80 440 L 60 520 L 0 540 Z"
              fill="#0A1F33"
              opacity="0.85"
              stroke="#1A3147"
              strokeWidth="0.6"
            />
            <path
              d="M 1500 130 L 1600 140 L 1600 360 L 1560 380 L 1530 350 L 1510 280 L 1490 200 Z"
              fill="#0A1F33"
              opacity="0.85"
              stroke="#1A3147"
              strokeWidth="0.6"
